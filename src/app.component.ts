      ...
      <div class="flex items-center justify-between h-16 gap-4">
        ...
        <div class="flex items-center space-x-3 flex-shrink-0">
          ...
          <div>
            ...
            <a href="https://kadoffice.ru" target="_blank" rel="noopener noreferrer" class="block text-xs md:text-sm font-medium text-indigo-600 hover:text-indigo-700 transition-colors">kadoffice.ru</a>
          </div>
        </div>
